...
for i in range(niter):
    ...
    delta = 0.40*(1/m+np.sqrt(np.log(np.maximum(d,n))/k)) # mettre 0.3/m pour d = 1000 par exemple
    ...
    #pd.DataFrame.to_csv(A_hat, "results/results_model_3/model_3_" + str(int(d)) + "_" + str(int(k)) + "/Ahat_" + str(int(i)) + ".csv")
    #pd.DataFrame.to_csv(A, "results/results_model_3/model_3_" + str(int(d)) + "_" + str(int(k)) + "/A" + str(int(i)) + ".csv")
